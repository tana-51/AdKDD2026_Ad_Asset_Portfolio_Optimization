...
def main(cfg: DictConfig) -> None:
    ...
    beta_list = cfg.setting.vary.beta_list
    ...
    for beta in beta_list:
        ...
        for _ in tqdm(range(num_runs), desc=f"beta={beta}..."):
        ...
        result_df.to_csv(f"{save_path}beta.csv")
        plot(
            result_df=result_df,
            varying_name="beta",
            varying_list=beta_list,
            axis_name=rf"$\beta$",
            log_scale=False,
            save_path=save_path,
        )
